...
},{"axios":"../node_modules/axios/index.js"}],"pages/account/account.api.js":[function(require,module,exports) {
"use strict";
...
var _account3 = require("./account.api");
...
if (isEditMode) {
  (0, _account2.getAccount)(params.id).then(function (apiAccount) {
    account = (0, _account4.mapAccountFromApiToViewModel)(apiAccount);
...
var onSave = function onSave() {
  var apiAccount = (0, _account4.MapAccountFromViewModelToApi)(account);
  return isEditMode ? (0, _account3.updateAccount)(apiAccount) : (0, _account3.insertAccount)(apiAccount);
};
...
},{"../../common/helpers":"common/helpers/index.js","./account.validations":"pages/account/account.validations.js","../../core/router":"core/router/index.js","../../common/api/account.api":"common/api/account.api.js","./account.api":"pages/account/account.api.js","./account.mappers":"pages/account/account.mappers.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
